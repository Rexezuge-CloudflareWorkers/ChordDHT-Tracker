import type { IClock, ILogger } from '@chord-dht-tracker/shared/utils';
import { ConsoleLogger } from '@chord-dht-tracker/shared/utils';
import { SystemClock } from '@chord-dht-tracker/shared/utils';
import type { ServiceEnv } from '../config/ServiceEnv';

/**
 * Single request-scoped context replacing bespoke `*Env`
