...
describe('GET /tracker/stable_base', () => {
  it('reports an empty stable base from vars (no members configured)', async () => {
    ...
    expect(body.configured_count).toBe(0);
  ...
  it('still reports zero members after unrelated nodes register', async () => {
